...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateJoueur = $db->prepare("UPDATE joueur SET nom = ?, prenom = ?, age = ?, ville = ?, poste = ?, email = ? WHERE id = ?");
    $updateJoueur->execute([$nom, $prenom, $age, $ville, $poste, $email, $id]);
...
<form action="/updateForm.php?id=' . $id . '" method="POST">
    <div class="mb-3">
        <div class="col">
